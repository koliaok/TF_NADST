...
parser.add_argument('-save_path','--save_path', help='path of the file to load', required=False, default='save/nadst')
parser.add_argument('-patience','--patience', help='', required=False, default=8, type=int)
...
parser.add_argument('-gate', '--slot_gating', help='', required=False, default=1, type=int)
